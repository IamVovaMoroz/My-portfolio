    ...
    <div className='my-64'>
      ...
      <div className='w-[75%] mx-auto relative lg:w-[90%] md:w-full'>
        ...
        <ul className='w-full flex flex-col items-start justify-between ml-4  xs:ml-2'>
          <Details
            type='Full-Stack Developer courses'
            time='2022-2024'
            place='ITVDN, Udemy'
            info='Completed a series of courses covering various programming languages, frameworks, and libraries to enhance proficiency in web development; some certificates are available on my LinkedIn page.'
          />
